...
r  * The third one is layer 2.
  * This 'enum' lets us use names like QWERTY, FUNCTION, and NUMPAD in place of
  * the numbers 0, 1 and 2.
  *
  */

enum { COEUR, NUMPAD, FUNCTION, QWERTY }; // layers
...
KEYMAPS(
  ...
  (Key_Tab,       Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   M(MACRO_ANY),      Key_Y, Key_U, Key_I,     Key_O,         Key_P,         Key_LeftBracket,
                      Key_H, Key_J, Key_K,     Key_L,         Key_Semicolon, Key_Quote,
   Key_Tab,           Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_RightBracket,
   Key_RightGui,  Key_Enter, Key_Spacebar, Key_RightAlt,
   ShiftToLayer(FUNCTION)),
  ...
  (Key_Esc,      Key_F1,           Key_F2,        Key_F3,        Key_F4,        Key_F5,           XXX,
   Key_Tab,  ___,              Key_mouseBtnL, Key_mouseBtnM, Key_mouseBtnR, Key_mouseWarpEnd, Key_mouseWarpNE,
   ___, Key_mouseL,       Key_mouseDn,   Key_mouseUp,   Key_mouseR,    Key_mouseWarpNW,
   ___,  Key_PrintScreen,  Key_Pause,     Key_Insert,    Key_Delete,    Key_mouseWarpSW,  Key_mouseWarpSE,
   ___, ___, ___, ___,
   ___,
   ...
   Key_PcApplication, Consumer_Mute,          Consumer_VolumeDecrement, Consumer_VolumeIncrement, Consumer_PlaySlashPause, Consumer_ScanPreviousTrack, Consumer_ScanNextTrack,
